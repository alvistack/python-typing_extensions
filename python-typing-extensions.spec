...
%package -n python%{python3_version_nodots}-typing-extensions
Summary: Python Typing Extensions
Requires: python3
...
%description -n python%{python3_version_nodots}-typing-extensions
Typing Extensions - Backported and Experimental Type Hints for Python.

%package -n python%{python3_version_nodots}-typing_extensions
Summary: Python Typing Extensions
Requires: python%{python3_version_nodots}-typing-extensions = %{epoch}:%{version}-%{release}

%description -n python%{python3_version_nodots}-typing_extensions
Typing Extensions - Backported and Experimental Type Hints for Python.

%files -n python%{python3_version_nodots}-typing-extensions
%license LICENSE
%{python3_sitelib}/*
...
Summary: Python Typing Extensions
Requires: python3-typing-extensions = %{epoch}:%{version}-%{release}
